...
<head>
    ...
    <title>Borrow Book | UNESWA Library</title>
...
<body>
    ...
    <main>
        <div class="container">
            <h1 class="page-title">Book Borrowing</h1>
            ...
            <div class="borrow-card">
                <div class="card-header">
                    <h2>Borrow a Book</h2>
                    <p>Scan the QR code on the back of the book to borrow it</p>
                </div>
                
                <div class="qr-section">
                    <img src="/php_program/Barrowing_system/Images/bookscanning.jpg" alt="QR Code Example" class="qr-image">
                    <p class="qr-caption">The QR code is located on the back cover of the book</p>
                </div>
                
                <button class="scan-button" onclick="window.location.href='book_scanner.php'">
